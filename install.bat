REM Installs Jared Rummler's IntelliJ configs into your user configs.
@echo off
echo Installing Jared Rummler's IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'JaredRummler'.
exit /b
